...
(define-fun nextto_in0 ((l Int) (r Int)) Bool
  (and (= l p0_in0)  (= r p1_in0) (< l r))
  )
(assert (!(nextto_in0 p0_in0 p1_in0) :named nextto_in0_p0_p1))
(define-fun nextto_out0 ((l Int) (r Int)) Bool
  (and (= l p_unknown_out0)  (= r p_new_out0) (< l r))
  )
(assert (!(nextto_out0 p_unknown_out0 p_new_out0) :named nextto_out0_p_unknown_p_new))


; reachable relations
(define-fun-rec reachable_in0 ((l Int) (r Int)) Bool
  (or (and (= l p1_in0)  (= r pn_in0) (<= l r))
      (= l r)
      (nextto_in0 l r)
      (exists ((m Int)) (and (nextto_in0 l m) (reachable_in0 m r)))
      (exists ((m Int)) (and (reachable_in0 l m) (nextto_in0 m r)))))
(assert (!(reachable_in0 p1_in0 pn_in0) :named reach_in0_p1_pn))
(define-fun-rec reachable_out0 ((l Int) (r Int)) Bool
  (or (and (= l p1_out0)  (= r pn_out0) (<= l r))
      (= l r)
      (nextto_out0 l r)
      (exists ((m Int)) (and (nextto_out0 l m) (reachable_out0 m r)))
      (exists ((m Int)) (and (reachable_out0 l m) (nextto_out0 m r)))))
(assert (!(reachable_out0 p1_out0 pn_out0) :named reach_out0_p1_pn))


; aliases
(assert (! (not (= head_in0 0)) :named alias_head_in0_0))
(assert (! (= end_in0 p_unknown_in0) :named alias_end_in0_p_unknown_in0))
(assert (! (= head_in0 p0_in0) :named alias_head_in0_p0_in0))
...
(assert (! (= head_out0 p0_out0) :named alias_head_out0_p0_out0))
(assert (! (= back_out0 pn_out0) :named alias_back_out0_pn_out0))
(assert (! (= begin_out0 p1_out0) :named alias_begin_out0_p1_out0))
(assert (! (= p_unknown_in0 p_unknown_out0) :named unchanged_p_unknown_in0_out0))
(assert (! (= p0_in0 p0_out0) :named unchanged_p0_in0_out0))
(assert (! (= pn_in0 pn_out0) :named unchanged_pn_in0_out0))
(assert (! (= p1_in0 p1_out0) :named unchanged_p1_in0_out0))
