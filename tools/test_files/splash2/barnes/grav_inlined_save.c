/*@;BEGIN(Func1=FunctionDecl)@*/void walksub(nodeptr n,real dsq,long ProcessId) {
   real _Local_ProcessId_dr;
   real _Local_ProcessId_dr_1;
   real _Local_ProcessId_dr_2;
   nodeptr* nn;
   leafptr l;
   bodyptr p;
   long i;
   bool xx;
   {
      ...
      _Local_ProcessId_dr = Pos(p)[0]-Local[ProcessId].pos0[0];
      _Local_ProcessId_dr_1 = Pos(p)[1]-Local[ProcessId].pos0[1];
      _Local_ProcessId_dr_2 = Pos(p)[2]-Local[ProcessId].pos0[2];
      Local[ProcessId].drsq = _Local_ProcessId_dr*_Local_ProcessId_dr+_Local_ProcessId_dr_1*_Local_ProcessId_dr_1+_Local_ProcessId_dr_2*_Local_ProcessId_dr_2;
                  ...
                  if (p!=Local[ProcessId].pskip)  
                    {
                       ...
                       ai[0] = _Local_ProcessId_dr*mor3;
                       ai[1] = _Local_ProcessId_dr_1*mor3;
                       ai[2] = _Local_ProcessId_dr_2*mor3;
