...
void VListInteraction(long my_id,box* source_box,box* dest_box) {
   ...
   complex _z0_pow_minus_n_0;
   complex _z0_pow_minus_n_1;
   /*@;BEGIN(Nest1_1=Nest)@*/for (k=1; k<-1+Expansion_Terms; k+=2) 
     {
        _z0_pow_minus_n_0.r = z0_pow_minus_n[-1+k].r*z0_inv.r-z0_pow_minus_n[-1+k].i*z0_inv.i;
        _z0_pow_minus_n_0.i = z0_pow_minus_n[-1+k].r*z0_inv.i+z0_pow_minus_n[-1+k].i*z0_inv.r;
        _z0_pow_minus_n_1.r = _z0_pow_minus_n_0.r*z0_inv.r-_z0_pow_minus_n_0.i*z0_inv.i;
        _z0_pow_minus_n_1.i = _z0_pow_minus_n_0.r*z0_inv.i+_z0_pow_minus_n_0.i*z0_inv.r;
        z0_pow_minus_n[k] = _z0_pow_minus_n_0;
        z0_pow_minus_n[1+k] = _z0_pow_minus_n_1;
     }
