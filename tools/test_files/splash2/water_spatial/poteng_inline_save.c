                            ...
                            while (curr_ptr)  
                              {
                                 ...
                                 {
                                    double* XA=curr_ptr->mol.F[DISP][YDIR];
                                    double* XB=neighbor_ptr->mol.F[DISP][YDIR];
                                    double XMA=curr_ptr->mol.VM[YDIR];
                                 ...
                                 {
                                    double* XA=curr_ptr->mol.F[DISP][ZDIR];
                                    double* XB=neighbor_ptr->mol.F[DISP][ZDIR];
                                    double XMA=curr_ptr->mol.VM[ZDIR];
