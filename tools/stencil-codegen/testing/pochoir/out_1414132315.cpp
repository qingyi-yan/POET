...
int main(int argc, char ** argv) 
{
  ...
  Pochoir_Shape_1D stencil_shape[] = {{1,0}, {0,-2}, {0,-1}, {0,1}, {0,2}, {0,0}};
  Pochoir_1D stencil(stencil_shape);

  Pochoir_Kernel_1D(stencil_fn,t,i0)
  u(t+1,i0) = ((((-0.083 * u(t,i0-2) + 1.33 * u(t,i0-1) + -2.5 * u(t,i0) + 1.33 * u(t,i0+1) + -0.083 * u(t,i0+2)) * divvar) * divvar) * divvar) * divvar + 1*u(t,i0);
  Pochoir_Kernel_End
