...
//double divvar=(double)(floor(fmod(rand(),1))+2);
  double divvar=(double)(rand() % 256)/16 + 1;
  double c1 =(double)(rand() % 256)/16 + 1;
  double c2 =(double)(rand() % 256)/16 + 1;
  double c3 =(double)(rand() % 256)/16 + 1;
    ...
    for (i1=1; i1<-1+N1; i1+=1)
      {
         for (i0=1; i0<-1+N0; i0+=1)
           {
              u[tnew][i0][i1] = (3./(2.*c1)) +
                ((1*u[tm1][-1+i0][i1]+(-2*u[tm1][i0][i1])+(1*u[tm1][1+i0][i1]))/c2/c2+((1*u[tm1][i0][-1+i1])+(-2*u[tm1][i0][i1])+(1*u[tm1][i0][1+i1]))/c3/c3)+(u[tm1][i0][i1]*1)/divvar/divvar;
           }
      }
  }
#pragma endscop
