...
#ifdef NONBLOCKING_MULTIHASHSET
...
template<class T> typename hash_set<T>::template GC_Wrapper_Queue<typename hash_set<T>::wrapper_t>* hash_set<T>::GarbageCollector::wrapper_to_reuse[GC_MAX_THREADS];
template<class T> typename hash_set<T>::template GC_Node_Queue<typename hash_set<T>::gc_node_t>* hash_set<T>::GarbageCollector::node_to_reuse[GC_MAX_THREADS];
template<class T> typename hash_set<T>::template GC_SynObj_Queue_Alloc<typename hash_set<T>::synobj_t>* hash_set<T>::GarbageCollector::obj_blocks[GC_MAX_THREADS];
