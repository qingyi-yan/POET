...
template<class T> typename MDList<T>::template GC_SynObj_Queue_Alloc<typename MDList<T>::synobj_t>* MDList<T>::GarbageCollector::obj_blocks[GC_MAX_THREADS];
template<class T> typename MDList<T>::template GC_Wrapper_Queue<typename MDList<T>::wrapper_t>* MDList<T>::GarbageCollector::wrapper_to_reuse[GC_MAX_THREADS];
template<class T> typename MDList<T>::template GC_Node_Queue<typename MDList<T>::gc_node_t>* MDList<T>::GarbageCollector::node_to_reuse[GC_MAX_THREADS];
