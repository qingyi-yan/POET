...
#define vec_mov_mr_a(mem,reg)   gen_vec_mr(movupd,mem,reg)
#define vec_mov_rm_a(reg,mem)   gen_vec_rm(movupd,reg,mem)
#define vec_mov_rr(reg1,reg2)   gen_vec_rr(movupd,reg1,reg2)
 ...
 */
   #define vec_red2(v0, v1, vw) \
      __asm__ __volatile__("movupd " Mstr(v0) ", " Mstr(vw) "\n"\
 ...
 */
   #define vec_red4(v0, v1, v2, v3, w0, w1) \
      __asm__ __volatile__("movupd " Mstr(v0) ", " Mstr(w0) "\n"\
                           "movupd " Mstr(v2) ", " Mstr(w1) "\n"\
                           "unpcklpd " Mstr(v1) ", " Mstr(v0) "\n"\
